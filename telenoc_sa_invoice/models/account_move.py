...
class AccountMove(models.Model):
    ...
    l10n_sa_confirmation_datetime = fields.Datetime(string='Confirmation Date',compute="compute_confirmation_date", readonly=True, copy=False)

    def compute_confirmation_date(self):
        self.l10n_sa_confirmation_datetime = datetime.combine(self.invoice_date, datetime.min.time()) 
